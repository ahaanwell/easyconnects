    ...
    <div className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
      EasyConnects
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
              ...
              className="hidden md:block group relative bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-2.5 rounded-xl text-sm font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 cursor-pointer">
              ...
              <div className="absolute right-0 top-0 h-screen w-80 max-w-[85vw] bg-white shadow-2xl transform transition-transform duration-300 ease-in-out animate-slide-in-right z-10">
                <div className="flex flex-col h-full bg-white">
                  ...
                  <div className="p-6 border-t border-gray-200 bg-white">
                    <button 
                    onClick={() => setShowModal(true)}
                    className="w-full group relative bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-4 rounded-xl text-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 cursor-pointer">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              className="flex flex-col sm:flex-row gap-6 items-center mb-8">
                <button 
                onClick={() => setShowModal(true)}
                className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl text-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-2xl hover:shadow-blue-500/25 transform hover:-translate-y-1 cursor-pointer">
                  <span className="relative z-10 flex items-center">
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                ...
                <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 shadow-2xl">
                  <div className="flex items-center mb-4">
                    ...
                    <div className="flex-1 text-center">
                      <span className="text-white text-sm font-medium">EasyConnects Dashboard</span>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20 hover:border-white/40 transition-all duration-300 hover:-translate-y-2">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">EasyConnects Cleaner</h3>
              ...
              <button 
              onClick={() => setShowModal(true)}
              className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 font-semibold cursor-pointer">
                Buy Now
              </button>
            </div>
            ...
            <div className="group bg-gradient-to-br from-blue-500/20 to-purple-500/20 backdrop-blur-xl rounded-2xl p-8 border-2 border-blue-400/50 hover:border-blue-400/80 transition-all duration-300 hover:-translate-y-2 relative">
              ...
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">EasyConnects Advanced</h3>
              ...
              <button 
              onClick={() => setShowModal(true)}
              className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3 rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-300 font-semibold shadow-lg cursor-pointer">
                Buy Now
              </button>
            </div>
            ...
            <div className="group bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20 hover:border-white/40 transition-all duration-300 hover:-translate-y-2">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">EasyConnects Premium</h3>
              ...
              <button 
              onClick={() => setShowModal(true)}
              className="w-full bg-gradient-to-r from-yellow-600 to-orange-600 text-white py-3 rounded-xl hover:from-yellow-700 hover:to-orange-700 transition-all duration-300 font-semibold cursor-pointer">
                Buy Now
              </button>
            </div>
          </div>
      ...
      <section id="testimonials" className="py-16 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Don't just take our word for it. Here's what our satisfied customers have to say about their experience with EasyConnects.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group bg-white/80 backdrop-blur-xl p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-white/50 hover:border-blue-200 hover:-translate-y-2">
              ...
              <blockquote className="text-gray-700 mb-6 text-lg leading-relaxed italic">
                "I have used this EasyConnects Softwares, it is a very powerful system optimization tool. It can boost your PC's performance by applying various registry fixes, removing junk files, and scanning for vulnerabilities."
              </blockquote>
              <div className="flex items-center">
            ...
            <div className="group bg-white/80 backdrop-blur-xl p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-white/50 hover:border-green-200 hover:-translate-y-2">
              ...
              <blockquote className="text-gray-700 mb-6 text-lg leading-relaxed italic">
                "I needed to find space on my 180GB hard drive. After using EasyConnects Cleaner, over 45GB of space was freed up. Excellent result and highly recommended!"
              </blockquote>
              <div className="flex items-center">
            ...
            <div className="group bg-white/80 backdrop-blur-xl p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-white/50 hover:border-purple-200 hover:-translate-y-2">
              ...
              <blockquote className="text-gray-700 mb-6 text-lg leading-relaxed italic">
                "I have used different cleaners, but EasyConnects Softwares Ultimate is the most effective tool I've found for maintaining the health of my PCs. Highly recommended!"
              </blockquote>
              <div className="flex items-center">
      ...
      <section id="faq" className="py-16 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Need support? Find answers to the most common questions about EasyConnects softwares and its features.
            </p>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                answer: "Your score is based on a few things, including setting up your EasyConnects protection, strengthening your security with our safety recommendations, and ensuring your personal info is safely monitored with Identity Protection. For example, if your information is exposed in a data breach your score may drop, but you can improve it by following our easy-to-follow remediation steps."
              },
              {
                question: "In which platform can I use EasyConnects softwares?",
                answer: "You can use EasyConnects Softwares only on Windows."
              },
              {
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Connect with thousands of EasyConnects users worldwide. Share tips, get support, and stay updated with the latest news.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-12 max-w-3xl mx-auto leading-relaxed">
              Join over 2.5 million users who trust EasyConnects to keep their PCs running at peak performance.

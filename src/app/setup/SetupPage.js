                ...
                <div className="relative z-10 h-full flex items-center justify-center">
                    <div className="text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <button
                                className="px-4 py-2 text-white rounded font-semibold cursor-pointer transition-colors shadow-lg"
                                style={{ backgroundColor: "#007dbd" }}
                                onMouseOver={e => (e.currentTarget.style.backgroundColor = "#005a8b")}
                                onMouseOut={e => (e.currentTarget.style.backgroundColor = "#007dbd")}
                            ...
                            <button
                                className="px-4 py-2 bg-transparent border-2 border-white cursor-pointer text-white rounded font-semibold hover:bg-white hover:text-[#007dbd] transition-colors shadow-lg"
                                onClick={openSetupModal}
                            >
                                Setup Printer
                            </button>
